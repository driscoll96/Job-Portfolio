...
import edu.neu.ccs.cs5500.util.BaseException;
import edu.neu.ccs.cs5500.util.http.ResponseMessage;
import edu.neu.ccs.cs5500.util.http.ResponseMessageCodeEnum;
...
public class BaseExceptionAdvice {
  ...
  public ResponseMessage handlerAdcDaBaseException(Exception exception) {
    ...
    return Result
        .error(ResponseMessageCodeEnum.ERROR.getCode(), "System error, please contact admin");
  }
